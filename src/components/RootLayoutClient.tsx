...
export default function RootLayoutClient({
  ...
  return (
    <LiquidModeContext.Provider value={{ enabled: liquidMode, toggle: () => setLiquidMode((v) => !v) }}>
      <div className="flex flex-col min-h-screen">
        ...
        {!isDocsPage && <Footer />}
        <LiquidModeWarning show={liquidMode && showWarning} onClose={() => setShowWarning(false)} />
      </div>
