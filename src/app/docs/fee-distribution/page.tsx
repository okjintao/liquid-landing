  ...
  return (
    <DocsPageTemplate title="Fee Distribution">
      <p className="text-lg text-white/90 leading-relaxed">
        The LIQUID protocol implements a sophisticated fee distribution system that ensures fair and
        sustainable rewards for all participants while maintaining protocol stability.
      </p>
      ...
      <div className="space-y-6">
        ...
        <div className="bg-[var(--color-liquid-blue)]/10 border border-[var(--color-liquid-blue)]/20 rounded-xl p-6 hover:bg-[var(--color-liquid-blue)]/20 transition-all duration-300">
          ...
          <p className="text-white/80">
            Commissions earned by Valve Controller Modules are distributed to their holders based on
      ...
      <div className="space-y-6">
        ...
        <div className="bg-[var(--color-liquid-blue)]/10 border border-[var(--color-liquid-blue)]/20 rounded-xl p-6 hover:bg-[var(--color-liquid-blue)]/20 transition-all duration-300">
          ...
          <p className="text-white/80">
            A portion of fees is directed to the protocol treasury for development, marketing, and
      ...
      <div className="mt-8 p-6 bg-[var(--color-liquid-blue)]/10 border border-[var(--color-liquid-blue)]/20 rounded-xl hover:bg-[var(--color-liquid-blue)]/20 transition-all duration-300">
        ...
        <p className="text-white/80">
          Fees are collected automatically through smart contracts and distributed according to the
          configured parameters. All transactions are transparent and verifiable on-chain.
        </p>
      </div>
    </DocsPageTemplate>
  );
