  ...
  return (
    <DocsPageTemplate title="Valve Controllers">
      <p className="text-lg text-white/90 leading-relaxed">
        Valve Controller Modules (VCMs) are the core innovation of the LIQUID
        protocol, enabling holders to create and manage reward streams with
      ...
      <div className="space-y-6">
        <div className="bg-[var(--color-liquid-blue)]/10 border border-[var(--color-liquid-blue)]/20 rounded-xl p-6 hover:bg-[var(--color-liquid-blue)]/20 transition-all duration-300">
          ...
          <p className="text-white/80">
            Valve Controller Modules are NFT-based control mechanisms that allow
            holders to create and manage reward streams within the LIQUID
            ecosystem. Each VCM can be configured with custom parameters for
      ...
      <div className="space-y-6">
        <div className="bg-[var(--color-liquid-blue)]/10 border border-[var(--color-liquid-blue)]/20 rounded-xl p-6 hover:bg-[var(--color-liquid-blue)]/20 transition-all duration-300">
          ...
          <p className="text-white/80">
            VCM holders can collect their commissions at any time. The
            commission rate is applied to all transactions processed through the
            VCM.
          </p>
        </div>
