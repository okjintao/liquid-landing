...
export default function ValveControllersPage() {
  return (
    <DocsPageTemplate title="Valve Controllers">
      ...
      <h2 className="text-2xl font-bold text-slate-900 mt-8 mb-4">VCM Overview</h2>
      <div className="space-y-6">
        <div className="bg-white border border-slate-200 rounded-xl p-6 shadow-sm">
          <h3 className="text-xl font-bold text-slate-900 mb-2">What are VCMs?</h3>
      ...
      <h2 className="text-2xl font-bold text-slate-900 mt-8 mb-4">Creating a VCM</h2>
      <div className="space-y-6">
        <div className="bg-white border border-slate-200 rounded-xl p-6 shadow-sm">
        ...
        <div className="bg-white border border-slate-200 rounded-xl p-6 shadow-sm">
          ...
          <p className="text-slate-600">
            When creating a VCM, you can set:
          </p>
      ...
      <h2 className="text-2xl font-bold text-slate-900 mt-8 mb-4">Managing Your VCM</h2>
      <div className="space-y-6">
        <div className="bg-white border border-slate-200 rounded-xl p-6 shadow-sm">
          <h3 className="text-xl font-bold text-slate-900 mb-2">Commission Collection</h3>
          <p className="text-slate-600">
        ...
        <div className="bg-white border border-slate-200 rounded-xl p-6 shadow-sm">
          <h3 className="text-xl font-bold text-slate-900 mb-2">Parameter Updates</h3>
          <p className="text-slate-600">
            VCM parameters can be updated by the owner, including:
          </p>
          <ul className="list-disc list-inside text-slate-600 space-y-2 mt-2">
      ...
      <div className="mt-8 p-6 bg-slate-50 border border-slate-200 rounded-xl">
        ...
        <p className="text-slate-600">
          VCMs can be traded on the marketplace, allowing holders to:
        </p>
        <ul className="list-disc list-inside text-slate-600 space-y-2 mt-2">
