...
export default function DeployedContractsPage() {
  return (
    <DocsPageTemplate title="Deployed Contracts">
      ...
      <h2 className="text-2xl font-bold text-white mt-8 mb-4">Core Contracts</h2>
      <div className="space-y-6">
        <div className="bg-[var(--color-liquid-blue)]/10 border border-[var(--color-liquid-blue)]/20 rounded-xl p-6 hover:bg-[var(--color-liquid-blue)]/20 transition-all duration-300">
          ...
          <p className="text-white/80">
            The main token contract implementing the ERC-20 standard with additional
      ...
      <h2 className="text-2xl font-bold text-white mt-8 mb-4">Protocol Contracts</h2>
      <div className="space-y-6">
        <div className="bg-[var(--color-liquid-blue)]/10 border border-[var(--color-liquid-blue)]/20 rounded-xl p-6 hover:bg-[var(--color-liquid-blue)]/20 transition-all duration-300">
          <h3 className="text-xl font-bold text-white mb-2">Valve Controller Factory</h3>
          <p className="text-white/80">
        ...
        <div className="bg-[var(--color-liquid-blue)]/10 border border-[var(--color-liquid-blue)]/20 rounded-xl p-6 hover:bg-[var(--color-liquid-blue)]/20 transition-all duration-300">
          <h3 className="text-xl font-bold text-white mb-2">Reward Distributor</h3>
          <p className="text-white/80">
      ...
      <h2 className="text-2xl font-bold text-white mt-8 mb-4">Utility Contracts</h2>
      <div className="space-y-6">
        <div className="bg-[var(--color-liquid-blue)]/10 border border-[var(--color-liquid-blue)]/20 rounded-xl p-6 hover:bg-[var(--color-liquid-blue)]/20 transition-all duration-300">
      ...
      <div className="mt-8 p-6 bg-[var(--color-liquid-blue)]/10 border border-[var(--color-liquid-blue)]/20 rounded-xl hover:bg-[var(--color-liquid-blue)]/20 transition-all duration-300">
        <h3 className="text-xl font-bold text-white mb-2">Contract Verification</h3>
        <p className="text-white/80">
          All contracts are verified on Etherscan and can be viewed for transparency. Contract
          addresses are subject to change during protocol upgrades, which will be announced through
          official channels.
        </p>
      </div>
    </DocsPageTemplate>
